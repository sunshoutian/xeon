...
// It's here to make your overall experience more familiar with the APIs you used before Xeon.
import (
	"net"
	"net/url"
	"os"

	"github.com/radicalmind/xeon/cache"
...
// used to use (usually with third-party net/http Handlers) to an context.Handler.
//
...
//
// Deprecated. Use "github.com/radicalmind/xeon/cache" sub-package instead.
...
const (
	...
	MethodTrace   = "TRACE"
	// MethodNone is declared at xeon.go, it will stay.
)
