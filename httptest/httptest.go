...
// is useful when you need to have more than one test framework for the same xeon instance
// usage:
// xeon.Default.Get("/mypath", func(ctx context.Context){ctx.Write("my body")})
// ...
// e := httptest.New(xeon.Default, t)
// e.GET("/mypath").Expect().Status(xeon.StatusOK).Body().Equal("my body")
//
// You can find example on the https://github.com/radicalmind/xeon/glob/master/context_test.go
func New(app *xeon.Application, t *testing.T, setters ...OptionSetter) *httpexpect.Expect {
