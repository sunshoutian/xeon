...
func main() {
	...
	// create a custom path reverser, xeon let you define your own host and scheme
	// which is useful when you have nginx or caddy in front of xeon.
