...
// Secondly, execute the command: cd $GOPATH/src/github.com/radicalmind/xeon/_examples/intermediate/serve-embedded-files && go-bindata ./assets/...
...
func main() {
	...
	// Xeon gives you a way to integrade these functions to your web app
