...
//
// Usage:
// app := xeon.Run(xeon.Addr(":8080"), xeon.WithConfiguration(xeon.YAML("myconfig.yml")))
...
//
// Usage:
// app := xeon.Run(xeon.Addr(":8080"), xeon.WithConfiguration(xeon.YAML("myconfig.tml")))
...
// WithoutInterruptHandler  it disables the automatic graceful server shutdown
...
// Configuration the whole configuration for an Xeon instance
...
type Configuration struct {
	...
	// you have to install a dependency first and re-get the Xeon pgk:
	// $ sudo apt-get install libgtk-3-dev libappindicator3-dev
	// "$ go get -u github.com/radicalmind/xeo
	//
	//  Defaults to false.
	...
	// Change to false it if you want something like this https://github.com/radicalmind/xeon/issues/135 to work
	//
	...
	// currently we have only one: https://github.com/radicalmind/xeon/tree/master/middleware/i18n.
	//
	// Defaults to "xeon.translate" and "xeon.language"
...
//
// Usage:
// app.Run(xeon.Addr(":8080"), xeon.WithConfiguration(xeon.Configuration{/* fields here */ }))
// or
// xeon.WithConfiguration(xeon.YAML("./cfg/xeon.yml"))
// or
// xeon.WithConfiguration(xeon.TOML("./cfg/xeon.tml"))
...
// DefaultConfiguration returns the default configuration for an Xeon station, fills the main Configuration
func DefaultConfiguration() Configuration {
	return Configuration{
		...
		Charset:                           "UTF-8",
		TranslateFunctionContextKey:       "xeon.translate",
		TranslateLanguageContextKey:       "xeon.language",
		ViewLayoutContextKey:              "xeon.viewLayout",
		ViewDataContextKey:                "xeon.viewData",
